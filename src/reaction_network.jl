...
function coordinate(name, ex::Expr, p, scale_noise)
    ...
    typeex,constructorex = maketype(name, f, f_funcs, f_symfuncs, g, g_funcs, jumps, Meta.quot(jump_rate_expr), Meta.quot(jump_affect_expr), p_matrix, syms; params=params, symjac=symjac, mass_action_reactions=reactions)
